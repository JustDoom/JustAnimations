...
public class CopyFrameCmd implements SubCommand {
    ...
    public String getDescription() {
        return "Copies a frame and adds it to an animation";
    }
    ...
    public String[] getPermission() {
        return new String[]{"justanimations.copyframe", "justanimations.admin"};
    }
