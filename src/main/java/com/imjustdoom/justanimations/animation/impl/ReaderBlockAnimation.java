...
@Getter
@Setter
public class ReaderBlockAnimation implements IAnimation {
    ...
    public ReaderBlockAnimation() {
    }

    public ReaderBlockAnimation(World world, DataStore dataStore, String name) {
